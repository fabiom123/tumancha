{!!Html::style('assets/vendors/core/core.css')!!}
...
{!!Html::style('assets/vendors/dropify/dist/dropify.min.css')!!}
{!!Html::style('assets/vendors/sweetalert2/sweetalert2.min.css')!!}
